...
| M07 | next | Motion projection bridge. | Anatomy action bundles map to existing avatar controls and OpenSim/MuSkeMo-ready controls; wave/sit/run have deterministic compiled plans. |
