...
| M03 | next | Neo4j local graph service and constraints. | Docker service exists; indexes/constraints are generated; seed graph loads into Neo4j; Cypher validation tests pass locally. |
