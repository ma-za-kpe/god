...
| M08 | next | Soft tissue and microstructure materialization. | Skin patches, sweat glands, hair follicles, capillary beds, and render proxies use population templates and lazy materialization with tests. |
