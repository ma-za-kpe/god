...
| M06 | next | Browser anatomy inspection renderer. | The browser can render graph-derived body/system/head/knee/toe layers; screenshots prove visible output; missing mappings degrade visibly. |
