...
class TestVoiceAuthenticity:
    ...
    def test_voice_authenticity_zero_without_voice_dna(self, soul_config: SoulEngineConfig) -> None:
        result = _run(
            evaluate_enhanced(
                "Guard and hold what matters.",
                archetype="keeper",
                move="COUNTER",
                arc_theme="protection",
                config=soul_config,
                voice_dna=None,
            )
        )
...
class TestSubtextDepthConditioning:
    ...
    def test_subtext_depth_zero_without_instruction(self, soul_config: SoulEngineConfig) -> None:
        from banter.subtlety_director import SubtletyDirector
...
class TestShareabilityBonus:
    ...
    def test_shareability_capped_at_3(self, soul_config: SoulEngineConfig) -> None:
