...
- [ ] 1. Data model foundations
  - [-] 1.1 Add visual_state and avatar_base_cid to AgentIdentity in owned_graph.py
  ...
  - [-] 1.2 Create archetype_config.py with all 8 archetype style/voice/utterance configurations
...
- [ ] 2. Infrastructure setup
  - [-] 2.1 Add Docker Compose sidecar services for ComfyUI and Fish Speech
  ...
  - [-] 2.2 Create ComfyUI workflow JSON templates
...
- [ ] 3. Service integrations
  - [~] 3.1 Implement PortraitGenerator (ComfyUI integration) in portrait_generator.py
  ...
  - [~] 3.2 Implement VoiceCloner (Fish Speech S2 / CosyVoice integration) in voice_cloner.py
  ...
  - [~] 3.3 Implement VisualReactor for runtime beat-to-expression binding in visual_reactor.py
  ...
  - [-] 3.4 Implement SceneComposer for multi-Elder layout in scene_composer.py
  ...
  - [-] 3.5 Enhance VoiceSurface with prosody binding in voice/engine.py and voice/state.py
...
- [ ] 4. Orchestrators
  - [~] 4.1 Implement GenesisPipeline orchestrator in genesis_pipeline.py
  ...
  - [~] 4.2 Implement EvolutionEngine for long-term portrait evolution in evolution_engine.py
...
- [ ] 5. Integration layer
  - [~] 5.1 Implement pipeline observability with structured JSON logging
  ...
  - [~] 5.2 Integrate pipeline dispatch into seed_agents.py
  ...
  - [~] 5.3 Integrate VisualReactor and SceneComposer into AvatarSurface in avatar/engine.py
